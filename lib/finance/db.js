 ...
 * @returns {Promise<Array>}
 */
export async function loadBills(includeInactive = false) { /* Commit 2 */ }
 ...
 */
export async function insertBill(bill, client = supabase) { /* Commit 2 */ }
 ...
 * @returns {Promise<void>}
 */
export async function updateBill(id, changes, client = supabase) { /* Commit 2 */ }
 ...
 * @returns {Promise<void>}
 */
export async function deleteBill(id, client = supabase) { /* Commit 2 */ }
 ...
 * @returns {Promise<Array>}
 */
export async function loadBillPaymentsForBill(billId) { /* Commit 2 */ }
 ...
 * @returns {Promise<object>}
 */
export async function insertBillPayment(payment, client = supabase) { /* Commit 2 */ }
 ...
 * @returns {Promise<void>}
 */
export async function deleteBillPayment(id, client = supabase) { /* Commit 2 */ }
 ...
 */
export async function applyAutoLinkToTransaction(transactionId, client = supabase) { /* Commit 3 */ }
